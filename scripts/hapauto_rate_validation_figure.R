...
# Qmat <- as.matrix(read.csv("../data/transition_matrix/Q_matrix_hapauto_base.csv",
#                            as.is=T,header=T))

# For analysis of adjusted prior rates
# Qmat <- as.matrix(read.csv("../data/transition_matrix/Q_matrix_hapauto_adjusted_prior.csv",
#                            as.is=T,header=T))
...
save(testHist, file = "../outputs/testHist.RData")
save(testHistFixed, file = "../outputs/testHistFixed.RData")
