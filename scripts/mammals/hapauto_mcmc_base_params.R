...
write.csv(parMat,
          paste0("../../data/mammals/transition_matrix/Q_matrix_hapauto_base.csv"),
          row.names=F,quote=F)
write.csv(mat,
          paste0("../../data/mammals/transition_matrix/transition_matrix_hapauto.csv"),
          row.names=F,quote=F)
save(model.mcmc,model.mcmc.postburn,file="../../outputs/mammals/mcmc/hapauto_base.RData")
