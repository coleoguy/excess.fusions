x# This script produces a figure comparing rates of autosomal fusion and fission across different mammalian clades
...
for( i in 1:5){
  load(paste0("../../outputs/mcmc/subtrees/hapauto/",clades[i],".RData"))
